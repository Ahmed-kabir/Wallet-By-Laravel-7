...
<div class="container h-100 d-flex justify-content-center">
    <div class="jumbotron my-auto">
      <!-- Default form register -->
<form class="text-center border border-light p-5" action="{{route('userSaveByReffered')}}" method="post">
    @csrf
    ...
    <div class="form-row mb-4">
        <div class="col">
            ...
            <input type="hidden" id="defaultRegisterFormFirstName" name="user_unique_id" class="form-control" value="{{$user_unique_id}}">
        </div>
        <div class="col">
            <!-- Last name -->
