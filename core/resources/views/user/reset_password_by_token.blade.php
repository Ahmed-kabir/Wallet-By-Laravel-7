...
<div class="container h-100 d-flex justify-content-center">
    <div class="jumbotron my-auto">
        ...
        <form class="text-center border border-light p-5" action="{{route('updateForgotPasswordByToken')}}" method="post">
            @csrf
            ...
            <!-- Email -->
            <input type="text" id="defaultLoginFormEmail" name="token" class="form-control mb-4" placeholder="Enter Token">
